...
subject_level as (
	Select 
		...
		CASE #refernce fomr Michae Ritchie for internal org. codes
			...
			ELSE null
		END as CBC,ptVisit.Primary_Study_Cohort, 
...
Select  -- count(distinct subject_level.Research_Participant_ID)
	Visit_Info_ID, subject_level.Research_Participant_ID, subject_level.CBC, subject_level.Primary_Study_Cohort, subject_level.Type_Of_Visit, subject_level.Sunday_Prior_To_Visit_1, subject_level.Visit_Number, subject_level.Visit_Date_Duration_From_Index, subject_level.
Age, subject_level.Age_bin, subject_level.Race, subject_level.Ethnicity, subject_level.Sex_At_Birth, subject_level.Cancer_Description_Or_ICD10_codes, subject_level.`Harmonized Cancer Name`, subject_level.Cured, subject_level.Treatment, subject_level.Stop_Date_Duration_From_Index, subject_level.Treatment_type, subject_level.Vaccination_Status, subject_level.`SARS-CoV-2_Vaccine_Type`, subject_level.`SARS-CoV-2_Vaccination_Date_Duration_From_Index`, Breakthrough_COVID, subject_level.
