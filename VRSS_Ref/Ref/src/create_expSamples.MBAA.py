...
assay_data = cbcFxn.obtain_data('assay_data_2.1.0','Assay_Metadata')
...
TOP = cbcFxn.grab_top('experimentSamples.MBAA')
# print(TOP)
OUT = pd.DataFrame(columns=cbcFxn.grab_headers('experimentSamples.MBAA'))
...
headers = cbcFxn.grab_headers('experimentSamples.MBAA')
...
immport_template.to_csv(path.join(final_ref,'refr_experimentSamples.MBAA.v2.txt'),
