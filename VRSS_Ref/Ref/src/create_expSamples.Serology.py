...
Ids_interested = [
'41_474', '27_503', '41_472', '27_504', '27_506', '27_508', '14_080', 
'27_509', '32_040', '27_501', '14_020', '41_481', '27_507', '41_468', 
'32_048', '14_010', '32_070', '14_050', '32_060', '32_075', '27_502', 
'41_485', '41_476', '27_511', '32_047', '41_486', '32_065', '32_035', 
'41_470', '14_090', '27_510', '41_483', '14_070', '27_505'
]
...
total_ids = Ids_interested

################# Pull Data #################
serology_data = cbcFxn.obtain_data('serology_results_data_2.2.0','Raw Data')

assay_data = serology_data
# assay_data = serology_data.replace(np.nan, 'aaa', regex=True)
# print(assay_data['Assay_Target_Sub_Region'])
experiment_data = cbcFxn.obtain_data('refr-experiments-v3',base_dir=final_txt)
...
OUT['Expsample ID']=[f'refr-serology-{str(x)}' for x in range(LEN)]
...
OUT['Subject ID']=[x for x in assay_data['# Research_Participant_ID']]
...
OUT['Comments']=[f'Interpretation: {x}' for x in assay_data['Interperation Group']]


cbcFxn.create_final(OUT,'experimentSamples.ELISA', 'refr_experimentSamples.serology.v3.txt')
